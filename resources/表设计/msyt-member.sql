...
Source Database       : msyt-member

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2017-12-25 15:15:33
*/
...
CREATE TABLE `tb_button` (
  `idx` bigint(19) NOT NULL COMMENT '按钮主键idx，必须是分布式架构，全局唯一递增的##@Cache(module = "msyt-member")##',
...
CREATE TABLE `tb_department_p` (
  `idx` bigint(19) NOT NULL COMMENT '部门主键idx，分布式架构，全局唯一递增##@Cache(module = "msyt-member")##',
  `idx_code` bigint(19) DEFAULT NULL COMMENT '主键idx生成的code##@Long2S(targetField = "idxCode")##',
...
CREATE TABLE `tb_member` (
  `idx` bigint(19) NOT NULL COMMENT '成员主键idx，分布式架构，全局唯一递增##@Cache(module = "msyt-member")##',
  `idx_code` bigint(19) DEFAULT NULL COMMENT '主键idx生成的code##@Long2S(targetField = "idxCode")##',
...
CREATE TABLE `tb_member_cate_p` (
  `idx` bigint(19) NOT NULL COMMENT '成员类别（分类、类型）主键idx##@Cache(module = "msyt-member")##',
  `idx_code` bigint(19) DEFAULT NULL COMMENT '主键idx生成的code##@Long2S(targetField = "idxCode")##',
...
CREATE TABLE `tb_member_role` (
  `idx` bigint(19) NOT NULL COMMENT '成员角色主键idx，分布式架构，全局唯一递增##@Cache(module = "msyt-member")##',
  `idx_code` bigint(19) DEFAULT NULL COMMENT '主键idx生成的code##@Long2S(targetField = "idxCode")##',
...
CREATE TABLE `tb_menu_p` (
  `idx` bigint(19) NOT NULL COMMENT '菜单主键idx，必须是分布式全局唯一递增##@Cache(module = "msyt-member")##',
  `idx_code` bigint(19) DEFAULT NULL COMMENT '主键idx生成的code##@Long2S(targetField = "idxCode")##',
...
CREATE TABLE `tb_resource_group_p` (
  `idx` bigint(19) NOT NULL COMMENT '资源组主键idx，分布式架构，全局唯一递增##@Cache(module = "msyt-member")##',
  `idx_code` bigint(19) DEFAULT NULL COMMENT '主键idx生成的code##@Long2S(targetField = "idxCode")##',
...
CREATE TABLE `tb_resource_p` (
  `idx` bigint(19) NOT NULL COMMENT '资源主键idx，分布式架构，全局唯一递增##@Cache(module = "msyt-member")##',
  `idx_code` bigint(19) DEFAULT NULL COMMENT '主键idx生成的code##@Long2S(targetField = "idxCode")##',
...
CREATE TABLE `tb_role` (
  `idx` bigint(19) NOT NULL COMMENT '角色主键idx，分布式架构，全局唯一递增##@Cache(module = "msyt-member")##',
  `idx_code` bigint(19) DEFAULT NULL COMMENT '主键idx生成的code##@Long2S(targetField = "idxCode")##',
...
CREATE TABLE `tb_role_resource_group` (
  `idx` bigint(19) NOT NULL COMMENT '角色资源主键idx，必须分布式架构，全局唯一递增##@Cache(module = "msyt-member")##',
  `idx_code` bigint(19) DEFAULT NULL COMMENT '主键idx生成的code##@Long2S(targetField = "idxCode")##',
